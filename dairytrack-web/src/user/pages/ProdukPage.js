...
const produkList = [
  ...
  { nama: "Susu Sapi Organik", image: susuSegarFullCream, link: "produk-details.html", deskripsi: "Susu sapi segar yang dihasilkan dari sapi yang diberi pakan organik." },
];

const ProdukPage = () => {
  return (
    <div className="container mx-auto py-5">
      <div className="bg-gray-100 p-5 mt-32"> {/* Menambahkan margin top lebih banyak */}
        <h2 className="text-2xl font-bold text-center text-gray-800">Produk Susu Kami</h2>
      </div>
...
const ProdukItem = ({ nama, image, link, deskripsi }) => {
  return (
    <div className="col-sm-6 col-lg-4 all product">
      <div className="box">
        <div>
          ...
          <div className="detail-box">
            ...
            <div className="options">
              <a href={link} className="view-details-link">
                View Details
              </a>
            </div>
          </div>
