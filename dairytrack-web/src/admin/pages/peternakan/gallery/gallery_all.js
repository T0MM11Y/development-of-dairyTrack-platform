...
const GalleryAll = () => {
  ...
  const handleDelete = async (id) => {
    ...
    const loadingToast = Swal.fire({
      title: "Deleting...",
      text: "Please wait while the gallery item is being deleted.",
    ...
    try {
      ...
      Swal.close(); // Tutup loading spinner setelah proses selesai
    }
  };
      ...
      <div className="d-flex flex-column mb-4">
        <h2 className="text-primary mb-3 d-flex align-items-center justify-content-between">
          ...
          <button
            ...
            onClick={handleRefresh} // Tambahkan fungsi refresh
            title="Refresh Table"
            style={{
              padding: "7px",
              borderRadius: "50%",
