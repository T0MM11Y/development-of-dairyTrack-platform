...
from app.routes.auth import check_all_tokens
...
def create_app():
    ...
    # Jadwalkan fungsi check_all_tokens
    scheduler = BackgroundScheduler()
    scheduler.add_job(func=check_all_tokens_job, trigger="interval", hours=1)
    scheduler.start()

    return app

def check_all_tokens_job():
    """
    Wrapper untuk menjalankan fungsi check_all_tokens.
    """
