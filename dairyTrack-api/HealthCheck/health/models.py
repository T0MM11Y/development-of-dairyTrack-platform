...
class Cow(models.Model):
    ...
    managers = models.ManyToManyField(User, related_name='managed_cows', blank=True)
...
class Notification(models.Model):
    cow = models.ForeignKey("Cow", on_delete=models.CASCADE, related_name="notifications")
