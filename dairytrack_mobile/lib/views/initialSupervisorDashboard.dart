      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [Colors.deepOrange[400]!, Colors.deepOrange[400]!],
          ...
          boxShadow: [
            BoxShadow(
              color: Colors.deepOrange[400]!.withOpacity(0.3),
              blurRadius: 20,
              offset: Offset(0, 10),
            ),
          ],
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: const Color.fromARGB(255, 233, 245, 67)!
                          .withOpacity(0.8),
                      borderRadius: BorderRadius.circular(20),
                    ),
                    child: Text(
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: _selectedIndex == 0
                          ? Colors.deepOrange[400]!.withOpacity(0.1)
                          : null,
                    ),
                    child: ListTile(
                      leading: Container(
                        ...
                        decoration: BoxDecoration(
                          color: _selectedIndex == 0
                              ? Colors.deepOrange[400]!.withOpacity(0.2)
                              : Colors.grey[100],
                          borderRadius: BorderRadius.circular(10),
                        ),
                        child: Icon(
                  ...
                  _buildExpansionTile(
                    ...
                    color: Colors.brown,
                    items: [
                      {'index': 2, 'item': navigationItems[2]}, // Data Sapi
                      {
                        'index': 6,
                  ...
                  _buildExpansionTile(
                    ...
                    color: Colors.teal,
                    items: [
                      {'index': 3, 'item': navigationItems[3]}, // Pemerahan
                      {
                        'index': 4,
                  ...
                  _buildExpansionTile(
                    ...
                    color: Colors.green,
                    items: [
                      {'index': 14, 'item': navigationItems[14]}, // Jenis Pakan
                      {
                        'index': 15,
                        'item': navigationItems[15]
                      }, // Jenis Nutrisi
                      {'index': 16, 'item': navigationItems[16]}, // Pakan
                      {'index': 17, 'item': navigationItems[17]}, // Stock Pakan
                      {
                        'index': 18,
                        'item': navigationItems[18]
                      }, // Feed Schedule
                      {
                        'index': 19,
                        'item': navigationItems[19]
                      }, // Feed Item Harian
                    ],
                  ),
                  ...
                  _buildExpansionTile(
                    ...
                    items: [
                      ...
                      {'index': 8, 'item': navigationItems[8]}, // Gallery
                    ],
                  ),
                ],
              ),
        ...
        children: items.map((itemData) {
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(8),
              color:
                  isSelected ? Colors.deepOrange[400]!.withOpacity(0.1) : null,
            ),
            child: ListTile(
              ...
              leading: Container(
                ...
                child: Icon(
                  item.icon,
                  color: isSelected ? Colors.deepOrange[400] : Colors.grey[600],
                  size: 18,
                ),
              ),
              title: Text(
                item.label,
                style: TextStyle(
                  color: isSelected ? Colors.deepOrange[400] : Colors.grey[800],
