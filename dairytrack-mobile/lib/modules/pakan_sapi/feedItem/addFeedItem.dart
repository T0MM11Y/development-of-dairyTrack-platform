...
//           ? _dailyFeeds.firstWhere((feed) => feed.id == id,
//               orElse: () => _dailyFeeds.first)
//           : null;
//     });
//   }
...
//     print(
//         'Debug: Found ${matchingStocks.length} FeedStock entries for feedId $feedId');
...
//     print(
//         'Debug: Most recent FeedStock: id=${matchingStocks.first.id}, stock=${matchingStocks.first.stock}, updatedAt=${matchingStocks.first.updatedAt}');
...
//           id: 0,
//           dailyFeedId:
//               _selectedDailyFeedId!, // Still needed for the FeedItem object
...
//                                 const SizedBox(height: 4.0),
//                                 Text(_dateFormat
//                                     .format(_selectedDailyFeedDetails!.date)),
//                               ],
//                             ),
//                           ),
//                           Expanded(
...
//                                     style: TextStyle(color: Colors.grey)),
//                                 const SizedBox(height: 4.0),
//                                 Text(_cowsMap[_selectedDailyFeedDetails!.cowId]
//                                         ?.name ??
