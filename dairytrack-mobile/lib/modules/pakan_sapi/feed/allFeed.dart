              ...
              child: FutureBuilder<List<Feed>>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return const Center(child: Text('Tidak ada pakan ditemukan.'));
                  }
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Protein: ${feed.protein != null ? feed.protein!.toStringAsFixed(2) : 'N/A'}%',
                                style: TextStyle(color: Colors.grey[600]),
                              ),
                              Text(
                                'Energi: ${feed.energy != null ? feed.energy!.toStringAsFixed(2) : 'N/A'} kcal',
                                style: TextStyle(color: Colors.grey[600]),
                              ),
                              Text(
                                'Serat: ${feed.fiber != null ? feed.fiber!.toStringAsFixed(2) : 'N/A'}%',
                                style: TextStyle(color: Colors.grey[600]),
                              ),
                              Text(
                              ...
                              Text(
                                'Harga: Rp ${feed.price != null ? feed.price!.toStringAsFixed(2) : 'N/A'}',
                                style: TextStyle(color: Colors.grey[600]),
                              ),
                              Text(
