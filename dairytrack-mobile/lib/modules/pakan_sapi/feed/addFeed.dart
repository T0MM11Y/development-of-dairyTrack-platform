    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<FeedType>>(
        ...
        builder: (context, snapshot) {
          print('FutureBuilder state: ${snapshot.connectionState}, error: ${snapshot.error}, hasData: ${snapshot.hasData}'); // Debugging
          ...
          for (var feedType in feedTypes) {
            if (!uniqueFeedTypes.add(feedType)) {
              print('Duplicate FeedType found: ID: ${feedType.id}, Name: ${feedType.name}, CreatedAt: ${feedType.createdAt}, UpdatedAt: ${feedType.updatedAt}'); // Detailed debugging
            }
          }
                  ...
                  DropdownButtonFormField<FeedType>(
                    ...
                    onChanged: (value) {
                      setState(() {
                        ...
                        print('Selected FeedType: ID: ${_selectedFeedType?.id}, Name: ${_selectedFeedType?.name}'); // Debugging
                      });
                    },
                    validator: (value) {
                      if (value == null) {
