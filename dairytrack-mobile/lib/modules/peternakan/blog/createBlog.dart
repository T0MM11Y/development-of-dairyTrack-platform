...
class _CreateBlogState extends State<CreateBlog> {
  ...
  Future<void> _submitBlog() async {
    if (_photoFile == null) {
      _showErrorDialog('Please select a photo.');
      return;
    }
    ...
    try {
      ...
      await createBlog(blog, _photoFile);
      ...
      _showErrorDialog('Failed to create blog: $e');
    }
  }
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          TextButton(
            onPressed: () {
              Navigator.of(context).pop();
              Navigator.pushReplacementNamed(context, '/all-blogs');
            },
    ...
    return Column(
      ...
      children: [
        ...
        DropdownButtonFormField<int>(
          ...
          hint: const Text('Select a topic'), // Placeholder ditambahkan di sini
